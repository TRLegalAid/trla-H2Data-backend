...
def mark_inactive_low_accurates_as_fixed_task():
    perform_task_and_catch_errors(mark_all_inactive_low_accurates_as_fixed, "MARKING INACTIVE LOW ACCURACIES AS FIXED")
    perform_task_and_catch_errors(send_fixes_to_postgres, "IMPLEMENTING FIXES")


mark_inactive_low_accurates_as_fixed_task()
...
sched.add_job(mark_inactive_low_accurates_as_fixed_task, 'interval', days=1, start_date='2020-09-10 20:00:00', timezone='US/Eastern')
sched.start()
